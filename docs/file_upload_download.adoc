...
send a GET request using the thumbnailIdentifier from the response of File Upload post request with the ".thumbnail" extension.

Example request:

```sh
curl http:/localhost:8081/api/v1/file/mybucket/b9f6f58b-1b41-400f-b178-f91d11221b7c.thumbnail > my-downloaded-thumbnail.jpg
```
